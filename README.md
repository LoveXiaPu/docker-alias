...
```bash
$ curl -fsSL https://github.com/LoveXiaPu/docker-alias/blob/master/zshrc >> ~/.zshrc && source ~/.zshrc
```

In bash

```bash
$ curl -fsSL https://github.com/LoveXiaPu/docker-alias/blob/master/zshrc >> ~/.bashrc && source ~/.bashrc
```
